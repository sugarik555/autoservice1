...
<body>
    ...
    <div class="form">
    <!-- форма авторизации -->
        <h1 style="color:#000; padding-top:5px">Добавление услуги</h1>
        <br>
        <form action="./vendor/registr_services.php" method="post"> <!-- Указывает обработчик, к которому обращаются данные формы при их отправке на сервер -->
            ...
            <div class="button">
             ...
             <table>
                ...
                <tr>
                    ...
                    <td><?= $service[2] ?></td>
                    <td><?= $service[3] ?></td>
                    <td><a style="color:#000;" href="update_services.php?id=<?=$service[0] ?>">Изменить</a></td>
                    <td><a style="color:#000;" href="vendor/delete_services.php?id=<?=$service[0] ?>">Удалить</a></td>
                </tr>
            <?php
                }
