...
<body>
    ...
    <div class="form">
    <!-- форма авторизации -->
        <h1 style="color:#000; padding-top:5px">Добавление записи на услугу</h1>
        <br>
        <form action="./vendor/registr_records.php" method="post"> <!-- Указывает обработчик, к которому обращаются данные формы при их отправке на сервер -->
            <input type="text" name="fio" placeholder=" ФИО" required>
            <br>
            <br>
            <select id="selectvalue" class="menu" name="service" placeholder="услуга">
            <?php
            ...
            <br>
            <br>
            <select id="selectvalue" class="menu" name="master" placeholder="мастер">
            <?php
